...
def search_result():
    ...
    for r in results:
      if(title ==  r.title) is True:
           list1.append(r.title)
           list2.append(r.tags)
           list3.append(r.date_posted)
           list4.append(r.content)
    return render_template("search_result.html", count=len(list1), result1 = list1, result2 = list2, result3 = list3, result4 = list4)
db.session.commit()
